...
public class TdApi {
  ...
  public static class AuthorizationStateWaitPassword extends AuthorizationState {
    ...
    public AuthorizationStateWaitPassword(
        String passwordHint, boolean hasRecoveryEmailAddress, String recoveryEmailAddressPattern) {
  ...
  public static class CallStateDiscarded extends CallState {
    ...
    public CallStateDiscarded(
        CallDiscardReason reason, boolean needRating, boolean needDebugInformation) {
      this.reason = reason;
  ...
  public static class ChatEventMemberPromoted extends ChatEventAction {
    ...
    public ChatEventMemberPromoted(
        int userId, ChatMemberStatus oldStatus, ChatMemberStatus newStatus) {
      this.userId = userId;
  ...
  public static class InlineQueryResultLocation extends InlineQueryResult {
    ...
    public InlineQueryResultLocation(
        String id, Location location, String title, PhotoSize thumbnail) {
      this.id = id;
      this.location = location;
      this.title = title;
      this.thumbnail = thumbnail;
  ...
  public static class InlineQueryResultDocument extends InlineQueryResult {
    ...
    public InlineQueryResultDocument(
        String id, Document document, String title, String description) {
      this.id = id;
      this.document = document;
      this.title = title;
      this.description = description;
  ...
  public static class InputMessageDocument extends InputMessageContent {
    ...
    public InputMessageDocument(
        InputFile document, InputThumbnail thumbnail, FormattedText caption) {
      this.document = document;
      this.thumbnail = thumbnail;
      this.caption = caption;
    }
  ...
  public static class InputMessageVideoNote extends InputMessageContent {
    ...
    public InputMessageVideoNote(
        InputFile videoNote, InputThumbnail thumbnail, int duration, int length) {
  ...
  public static class InputMessageVoiceNote extends InputMessageContent {
    ...
    public InputMessageVoiceNote(
        InputFile voiceNote, int duration, byte[] waveform, FormattedText caption) {
      this.voiceNote = voiceNote;
      this.duration = duration;
  ...
  public static class MessageForwardedFromUser extends MessageForwardInfo {
    ...
    public MessageForwardedFromUser(
        int senderUserId, int date, long forwardedFromChatId, long forwardedFromMessageId) {
      this.senderUserId = senderUserId;
      this.date = date;
  ...
  public static class NetworkStatisticsEntryFile extends NetworkStatisticsEntry {
    ...
    public NetworkStatisticsEntryFile(
        FileType fileType, NetworkType networkType, long sentBytes, long receivedBytes) {
  ...
  public static class NetworkStatisticsEntryCall extends NetworkStatisticsEntry {
    ...
    public NetworkStatisticsEntryCall(
        NetworkType networkType, long sentBytes, long receivedBytes, double duration) {
      this.networkType = networkType;
      this.sentBytes = sentBytes;
      this.receivedBytes = receivedBytes;
      this.duration = duration;
  ...
  public static class OrderInfo extends Object {
    ...
    public OrderInfo(
        String name, String phoneNumber, String emailAddress, ShippingAddress shippingAddress) {
      this.name = name;
      this.phoneNumber = phoneNumber;
  ...
  public static class PasswordState extends Object {
    ...
    public PasswordState(
        ...
        String unconfirmedRecoveryEmailAddressPattern) {
  ...
  public static class RemoteFile extends Object {
    ...
    public RemoteFile(
        String id, boolean isUploadingActive, boolean isUploadingCompleted, int uploadedSize) {
      this.id = id;
  ...
  public static class ReplyMarkupShowKeyboard extends ReplyMarkup {
    ...
    public ReplyMarkupShowKeyboard(
        KeyboardButton[][] rows, boolean resizeKeyboard, boolean oneTime, boolean isPersonal) {
      this.rows = rows;
  ...
  public static class StorageStatisticsByChat extends Object {
    ...
    public StorageStatisticsByChat(
        long chatId, long size, int count, StorageStatisticsByFileType[] byFileType) {
      this.chatId = chatId;
      this.size = size;
      this.count = count;
  ...
  public static class UpdateMessageSendFailed extends Update {
    ...
    public UpdateMessageSendFailed(
        Message message, long oldMessageId, int errorCode, String errorMessage) {
      this.message = message;
      this.oldMessageId = oldMessageId;
  ...
  public static class UpdateNotificationSettings extends Update {
    ...
    public UpdateNotificationSettings(
        NotificationSettingsScope scope, NotificationSettings notificationSettings) {
      this.scope = scope;
      this.notificationSettings = notificationSettings;
    }
  ...
  public static class UpdateDeleteMessages extends Update {
    ...
    public UpdateDeleteMessages(
        long chatId, long[] messageIds, boolean isPermanent, boolean fromCache) {
      this.chatId = chatId;
  ...
  public static class UpdateFileGenerationStart extends Update {
    ...
    public UpdateFileGenerationStart(
        long generationId, String originalPath, String destinationPath, String conversion) {
  ...
  public static class UpdateNewInlineQuery extends Update {
    ...
    public UpdateNewInlineQuery(
        long id, int senderUserId, Location userLocation, String query, String offset) {
      this.id = id;
      this.senderUserId = senderUserId;
  ...
  public static class UpdateNewShippingQuery extends Update {
    ...
    public UpdateNewShippingQuery(
        long id, int senderUserId, String invoicePayload, ShippingAddress shippingAddress) {
      this.id = id;
      this.senderUserId = senderUserId;
      this.invoicePayload = invoicePayload;
      this.shippingAddress = shippingAddress;
  ...
  public static class AnswerCallbackQuery extends Function {
    ...
    public AnswerCallbackQuery(
        long callbackQueryId, String text, boolean showAlert, String url, int cacheTime) {
  ...
  public static class AnswerInlineQuery extends Function {
    ...
    public AnswerInlineQuery(
        long inlineQueryId,
        boolean isPersonal,
        InputInlineQueryResult[] results,
        int cacheTime,
        String nextOffset,
        String switchPmText,
        String switchPmParameter) {
  ...
  public static class AnswerShippingQuery extends Function {
    ...
    public AnswerShippingQuery(
        long shippingQueryId, ShippingOption[] shippingOptions, String errorMessage) {
  ...
  public static class ChangePhoneNumber extends Function {
    ...
    public ChangePhoneNumber(
        String phoneNumber, boolean allowFlashCall, boolean isCurrentPhoneNumber) {
      this.phoneNumber = phoneNumber;
  ...
  public static class CreateNewStickerSet extends Function {
    ...
    public CreateNewStickerSet(
        int userId, String title, String name, boolean isMasks, InputSticker[] stickers) {
      this.userId = userId;
      this.title = title;
      this.name = name;
      this.isMasks = isMasks;
  ...
  public static class EditInlineMessageCaption extends Function {
    ...
    public EditInlineMessageCaption(
        String inlineMessageId, ReplyMarkup replyMarkup, FormattedText caption) {
      this.inlineMessageId = inlineMessageId;
      this.replyMarkup = replyMarkup;
      this.caption = caption;
    }
  ...
  public static class EditInlineMessageLiveLocation extends Function {
    ...
    public EditInlineMessageLiveLocation(
        String inlineMessageId, ReplyMarkup replyMarkup, Location location) {
      this.inlineMessageId = inlineMessageId;
      this.replyMarkup = replyMarkup;
      this.location = location;
    }
  ...
  public static class EditInlineMessageText extends Function {
    ...
    public EditInlineMessageText(
        String inlineMessageId, ReplyMarkup replyMarkup, InputMessageContent inputMessageContent) {
      this.inlineMessageId = inlineMessageId;
      this.replyMarkup = replyMarkup;
      this.inputMessageContent = inputMessageContent;
    }
  ...
  public static class EditMessageCaption extends Function {
    ...
    public EditMessageCaption(
        long chatId, long messageId, ReplyMarkup replyMarkup, FormattedText caption) {
      this.chatId = chatId;
      this.messageId = messageId;
      this.replyMarkup = replyMarkup;
      this.caption = caption;
  ...
  public static class EditMessageLiveLocation extends Function {
    ...
    public EditMessageLiveLocation(
        long chatId, long messageId, ReplyMarkup replyMarkup, Location location) {
      this.chatId = chatId;
      this.messageId = messageId;
      this.replyMarkup = replyMarkup;
      this.location = location;
  ...
  public static class GetInlineQueryResults extends Function {
    ...
    public GetInlineQueryResults(
        int botUserId, long chatId, Location userLocation, String query, String offset) {
      this.botUserId = botUserId;
      this.chatId = chatId;
      this.userLocation = userLocation;
      this.query = query;
  ...
  public static class GetSupergroupMembers extends Function {
    ...
    public GetSupergroupMembers(
        int supergroupId, SupergroupMembersFilter filter, int offset, int limit) {
      this.supergroupId = supergroupId;
      this.filter = filter;
      this.offset = offset;
      this.limit = limit;
  ...
  public static class SearchMessages extends Function {
    ...
    public SearchMessages(
        String query, int offsetDate, long offsetChatId, long offsetMessageId, int limit) {
      this.query = query;
  ...
  public static class SearchSecretMessages extends Function {
    ...
    public SearchSecretMessages(
        long chatId, String query, long fromSearchId, int limit, SearchMessagesFilter filter) {
      this.chatId = chatId;
      this.query = query;
  ...
  public static class SetGameScore extends Function {
    ...
    public SetGameScore(
        long chatId, long messageId, boolean editMessage, int userId, int score, boolean force) {
      this.chatId = chatId;
      this.messageId = messageId;
  ...
  public static class SetInlineGameScore extends Function {
    ...
    public SetInlineGameScore(
        String inlineMessageId, boolean editMessage, int userId, int score, boolean force) {
      this.inlineMessageId = inlineMessageId;
      this.editMessage = editMessage;
      this.userId = userId;
      this.score = score;
